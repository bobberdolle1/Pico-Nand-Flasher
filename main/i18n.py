...
class I18n:
    ...
    def load_translations(self):
        ...
        self.translations["en"] = {
            ...
            "confirm_erase": "Are you sure you want to erase the flash? "
            ...
            "to_pico": "to Pico",
            "write_not_implemented": "⚠️ Write is not fully implemented "
                                     "in the current Pico main.py version.",
        ...
        self.translations["ru"] = {
            ...
            "confirm_erase": "Вы уверены, что хотите стереть flash? "
                             "Это навсегда удалит все данные.",
            "yes": "Да",
            "no": "Нет",
            "settings": "Настройки",
            "language": "Язык",
            ...
            "to_pico": "на Pico",
            "write_not_implemented": "⚠️ Запись в текущей версии Pico main.py "
                                     "не реализована до конца.",
        ...
        # Try to load external JSON translations and merge over defaults
        try:
            base_dir = os.path.join(os.path.dirname(__file__), "src", "resources", "i18n")

            def _load_lang(code: str, filename: str):
                ...
                if os.path.exists(path):
                    try:
                        ...
                        # Ignore malformed files and keep defaults
                        pass

            _load_lang("en", "en.json")
            _load_lang("ru", "ru.json")
        except Exception:
    ...
    def get_language_name(self, lang_code: str) -> str:
        ...
        names = {"en": self.translations["en"]["english"], "ru": self.translations["ru"]["russian"]}
